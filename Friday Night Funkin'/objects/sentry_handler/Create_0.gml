...
gmSentryVersion= "1.0.15";
gmSentryLogFilePrefix= "sentry\\sentry_";
...
ds_map_add(precomputeSdk,"name","GMS Sentry, By: Meseta & ZorroMundoYT");
...
//options and some default
options= ds_map_create();
sentry_set_option("backup_before_send",1);
sentry_set_option("backup_autoclean",1);
