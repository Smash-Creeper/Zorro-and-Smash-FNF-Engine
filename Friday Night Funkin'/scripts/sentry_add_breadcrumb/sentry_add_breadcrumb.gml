///@arg category the category of the breadcrumb, e.g. "ui.keypress.L"
///@arg level the level of the breadcrumb: SENTRY_CRITICAL, SENTRY_ERROR, SENTRY_WARNING, SENTRY_INFO, SENTRY_DEBUG
///@arg message a message
///@arg data* a map containing additional data
function sentry_add_breadcrumb() {
	with sentry_handler {
